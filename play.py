...
async def play(_, message: Message):
            ...
            if administrator == message.from_user.id:
                ...
                try:
                    ...
                    await USER.send_message(
                        message.chat.id, "**Lawless VC assistant joined this group for play music 🎵**")
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/9a91d44f53f34b9fdf3e3.jpg"
            ...
            [
                [
                    InlineKeyboardButton(
                        text="Channel 🔊",
                        url="https://t.me/Lawless_Updates")
